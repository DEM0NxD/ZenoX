...
✅ **Interactive Game** - Feed ZenoX mini-game with score tracking  
...
const CONFIG = {
  ...
  botName: "ZenoX",
  botDescription: "Your Cute Discord Companion - Fun, moderation, and Antinuke for your Discord server."
};
```
...
| Invite ZenoX | Hero Section | `botInviteUrl` |
...
### Interactive Game
Users can play a mini-game where they feed ZenoX. The game tracks score and provides fun interactions.
